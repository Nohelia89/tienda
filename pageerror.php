<?php
	...
	switch($err){
		case "userex":
			...
			break;
		case "prodex":
			$msg = "El c�digo de producto ingresado ya existe.";
			break;
		case "prodnot":
			$msg = "El c�digo de producto no fue encontrado.";
			break;
		case "usercar":
			$msg = "El nombre de usuario contiene caracteres no permitidos.";
			break;
		case "passcar":
			$msg = "La contrase�a contiene caracteres no permitidos.";
			break;
		case "userok":
		...
		case "errins":
			...
			break;
		case "erruser":
			$msg = "El usuario o la contrase�a no es correcta.";
			break;
		case "elem":
